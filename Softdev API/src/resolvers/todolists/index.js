...
module.exports = {
    createTodoList: async (req, res) => {
        ...
        return res.status(200).json({message: 'Sukses menambahkan todo list'})
    },
    ...
    updateTodoList: async (req, res) => {
        ...
        if (todolist.length == 0) return res.status(400).json({message: 'Gagal menambahkan todo list'})
        return res.status(200).json({message: 'Berhasil menambahkan todo list'})
    },
